                    ...
                    <section className="custom-banner-section" style={{ maxWidth: 1000, margin: '0 auto', padding: '28px 20px 60px' }}>
                        ...
                        >
                            <div className="custom-banner-text">
                                <div style={{ width: 28, height: 1, background: 'rgba(200,160,80,0.8)', marginBottom: 14 }} />
                                <h3 style={{
                                ...
                                <p style={{ color: 'rgba(200,160,80,0.85)', fontSize: '0.75rem', marginTop: 10, letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: 500 }}>
                                ...
                                >
                                    ...
                                    <span style={{ color: 'rgba(240,235,225,0.92)', fontSize: '0.82rem', fontWeight: 600, letterSpacing: '0.06em', whiteSpace: 'nowrap' }}>
                                        {t.talkToUs}
                                    </span>
                                </a>
                            </div>
