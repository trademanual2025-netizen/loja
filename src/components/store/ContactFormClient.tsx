    ...
    if (sent) {
        return (
            <div style={{ textAlign: 'center', padding: '48px 24px' }}>
                ...
                <h3 style={{ color: '#fff', fontWeight: 300, fontSize: '1.4rem', letterSpacing: '0.06em', marginBottom: 12 }}>{c.successTitle}</h3>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div className="form-group" style={{ margin: 0 }}>
                    <label className="form-label" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>{c.formName} *</label>
                    <input
                        className="input"
                ...
                <div className="form-group" style={{ margin: 0 }}>
                    <label className="form-label" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>{c.formEmail} *</label>
                    <input
                        className="input"
                        type="email"
            ...
            <div className="form-group" style={{ margin: 0 }}>
                <label className="form-label" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>{c.formSubject}</label>
                <input
                    className="input"
            ...
            <div className="form-group" style={{ margin: 0 }}>
                <label className="form-label" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem', letterSpacing: '0.15em', textTransform: 'uppercase' }}>{c.formMessage} *</label>
                <textarea
                    className="input"
            ...
            {whatsappLink && (
                <div style={{ textAlign: 'center', paddingTop: 8 }}>
                    <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.78rem' }}>{c.orWhatsapp}{' '}</span>
