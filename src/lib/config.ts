...
export const SETTINGS_KEYS = {
    ...
    STORE_BANNER_TITLE_EN: 'store_banner_title_en',
    STORE_BANNER_TITLE_ES: 'store_banner_title_es',
    STORE_BANNER_SUBTITLE: 'store_banner_subtitle',
    STORE_BANNER_SUBTITLE_EN: 'store_banner_subtitle_en',
    STORE_BANNER_SUBTITLE_ES: 'store_banner_subtitle_es',
